...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $query = "SELECT id, name, email, password FROM hotels WHERE email = :email";
    $db->query($query);
    $db->bind(':email', $email);
    $hotel = $db->single();
    
    if ($hotel && verify_password($password, $hotel['password'])) {
...
<head>
    ...
    <title>Hotel Login - <?php echo SITE_NAME; ?></title>
